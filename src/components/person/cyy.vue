<template>
   ...
   <div><h1 class="main-title badge badge-secondary" style="width: 100%;line-height: 40px;font-size: 30px;">美国参议院议员名录</h1></div>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//首选加州的数据
			let temparray = require('../../assets/person/json/canyiyuan.json');
			//检索所有的州
