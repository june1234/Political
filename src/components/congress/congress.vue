            ...
            <div  class="row" id="congress">                
                ...
                <div class="col-sm-6" >
                    <div class="logo-img" href="#senate">
                        <img src="@/assets/common/img/170px-Seal_of_the_United_States_Senate.svg.png">
                        <div class="logo-title">美国参议院</div>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="logo-img" href="#hor"> 
                        <img src="@/assets/common/img/170px-Seal_of_the_United_States_House_of_Representatives.svg.png">
                        <div class="logo-title">美国众议院</div>
                    </div>
                </div>
            </div>               
            <div id="senate">                
            ...
            myChart.setOption({ 
                 tooltip: {
                      formatter: function(params) {
                          return '姓名:'+names[params.dataIndex]+'<br/>'+
               ...
               tooltip: {
                   ...
                   formatter:function(params){
                       return  '姓名:'+params.data.name+'<br/>'
                               ...
                               +'社会/种族维度:'+params.value[1]+'<br/>'+
                               '经济/再分配维度:'+params.value[0]+'<br/>'+
                               '领导力 :'+params.value[2]
                   }
               },
               visualMap: {
                   ...
                   min:-1,
                   inRange: {
                       color: ['#313695', '#4575b4', '#74add1', '#abd9e9', '#e0f3f8', '#ffffbf', '#f46d43', '#d73027']
                   }
               },
               xAxis3D: {
                   name:'社会/种族维度',
